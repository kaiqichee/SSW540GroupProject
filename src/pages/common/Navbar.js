...
export function Navbar() {
    let bookIcon =  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-book" viewBox="0 0 16 16">
    ...
    if (localStorage.getItem("loggedIn") == "false"){
        ...
        return (
            <nav className="navbar navbar-expand-lg bg-light border-bottom py-3 px-5 d-flex justify-content-between">
                <a className="navbar-brand" href="/"> {bookIcon} Home</a>
                <div className="d-flex">
